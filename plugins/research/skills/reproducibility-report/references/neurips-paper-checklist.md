...
**Internal methodology:** See the CI standards reference (bundled at `research/agents/references/ci-standards.md`) for standardized CI computation (n = questions not seeds, paired comparisons, power analysis)
...
- ❌ Using n = seeds instead of n = questions (see CI standards reference)
