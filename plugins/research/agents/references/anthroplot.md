...
Copy `anthroplot.py` into your project (available from `~/.local/lib/plotting/` if deployed, or the [dotfiles repo](https://github.com/yulonglin/dotfiles) `lib/plotting/`), then:
